 ...
 * Date: 2 juin 2011
 * Description: Solutionnaire de l'exercie d'allocation dynamimque sur 
...
int main()
{
	...
	Magie* foudre	= new Magie(*feu);	//Ne pas seulement copier le pointeur!
	cout << endl;


	cout << "La magie feu a une force de : " << feu->getForce() << endl;
	feu->lancer();			// equivalent a (*feu).lancer()
	cout << endl;


	int forceGlace = (*glace).getForce();
	cout << "La magie glace a une force de : " << forceGlace << endl;
	(*glace).lancer();		// equivalent a glace->lancer()
	cout << endl;
	...
	// Desalocation dynamqiue de memoire
	delete foudre;
	delete glace;
	delete feu;
